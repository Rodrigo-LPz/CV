...
export const siteContent: Record<Locale, SiteContent> = {
  es: {
    ...
    sections: {
      ...
      references: {
        title: 'Referencias',
        description:
          '● Sistema Planetario — web animada que recrea el movimiento planetario.\n● Local Weather Forecast — consulta del clima actual por ciudades.\n● Resúmenes de libros — plataforma para leer resúmenes de obras clave.\n● Otros proyectos: Jackpot, Cursos, IES Haría - Planéate, JavaApplication - Archivo Manager y AdminGest.',
      },
      techStack: {
        title: 'Stack técnico',
        description:
  ...
  en: {
    ...
    sections: {
      ...
      references: {
        title: 'References',
        description: '● Planetary System — animated web app that simulates planetary movement.\n● Local Weather Forecast — current weather lookup by city.\n● Book Summaries — platform to read key book summaries.\n● Other projects: Jackpot, Courses, IES Haría - Planéate, JavaApplication - File Manager, and AdminGest.',
      },
      techStack: {
        title: 'Tech stack',
        description:
